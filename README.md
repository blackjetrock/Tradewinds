...
Within the data were a lot of binary tokens, these are Oric specific, so I wrote a small tool (decode2.tcl, I had two attempts at it), which turned the tokens into the correct text. And, there's the program.
